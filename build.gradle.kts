...
description = "A fork from msgpack-java specialized for Embulk plugins"
...
dependencies {
    compileOnly("org.embulk:embulk-api:0.10.42")
...
tasks.javadoc {
    title = "A fork from msgpack-java specialized for Embulk plugins"
    options {
        locale = "en_US"
        encoding = "UTF-8"
